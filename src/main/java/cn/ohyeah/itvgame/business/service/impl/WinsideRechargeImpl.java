...
public class WinsideRechargeImpl implements IRecharge {
	private static final Log log = LogFactory.getLog(WinsideRechargeImpl.class);
	...
	static  {
		...
		amountUnit = Configuration.getAmountUnit("winside");
		cashToAmountRatio = Configuration.getCashToAmountRatio("winside");
	}
	...
	public int queryBalance(Map<String, Object> props, Account account,ProductDetail detail,
		...
		return WinsideSubscribeUtil.queryCoins(buyURL, account.getUserId());
	}
