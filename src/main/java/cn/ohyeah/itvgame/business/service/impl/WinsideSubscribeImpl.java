...
public class WinsideSubscribeImpl extends AbstractSubscribeImpl {
	private static final Log log = LogFactory.getLog(WinsideSubscribeImpl.class);
	...
	public WinsideSubscribeImpl() {
		super("winside");
	}
	
	protected WinsideSubscribeImpl(String implName) {
		super(implName);
	}
