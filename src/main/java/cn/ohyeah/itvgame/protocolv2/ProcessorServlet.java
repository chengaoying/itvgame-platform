...
import cn.ohyeah.itvgame.protocolv2.DefaultProcessor;
import cn.ohyeah.itvgame.protocolv2.IProcessor;
import cn.ohyeah.itvgame.utils.BytesUtil;
...
public class ProcessorServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest req, HttpServletResponse rsp)
		...
		try {
			...
			BytesUtil.writeInt(outdata, 4, outdata.length-8);
